...
<a
    href="{{ $href }}"
    wire:navigate
    class="flex items-center px-3 py-2 text-sm rounded-md transition-colors {{ $active ? 'bg-dawn-50 dark:bg-dawn-900/30 text-dawn-700 dark:text-dawn-300 font-medium' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-gray-200' }}"
>
    <span class="w-5 h-5 mr-3 flex-shrink-0">
        @switch($icon)
            ...
            @case('check')
                ...
                @break
            @case('mute')
                <svg fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M9.383 3.076A1 1 0 0110 4v12a1 1 0 01-1.707.707L4.586 13H2a1 1 0 01-1-1V8a1 1 0 011-1h2.586l3.707-3.707a1 1 0 011.09-.217zM12.293 7.293a1 1 0 011.414 0L15 8.586l1.293-1.293a1 1 0 111.414 1.414L16.414 10l1.293 1.293a1 1 0 01-1.414 1.414L15 11.414l-1.293 1.293a1 1 0 01-1.414-1.414L13.586 10l-1.293-1.293a1 1 0 010-1.414z" clip-rule="evenodd"/></svg>
                @break
            @case('x')
            ...
            @case('layers')
                ...
                @break
            @default
                <svg fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v3.586L7.707 9.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l3-3a1 1 0 00-1.414-1.414L11 10.586V7z" clip-rule="evenodd"/></svg>
        @endswitch
    </span>
    {{ $label }}
</a>
