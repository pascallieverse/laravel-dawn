...
@php
    $classes = match($status) {
        ...
        'delayed' => 'bg-cyan-100 text-cyan-800 dark:bg-cyan-900/30 dark:text-cyan-300',
        'retrying' => 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-300',
