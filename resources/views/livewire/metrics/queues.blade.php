            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-gray-50 dark:bg-gray-800">
                        <th class="px-3 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Queue</th>
                    ...
                    @foreach($metrics as $metric)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                            ...
                            <td class="px-3 sm:px-6 py-4 text-right">
                                <a
                                    href="{{ route('dawn.metrics.preview', ['type' => 'queues', 'id' => base64_encode($metric['name'] ?? '')]) }}"
                                    wire:navigate
