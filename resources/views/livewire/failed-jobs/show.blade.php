<div wire:poll.3s>
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-6 sm:mb-8">
        <div class="min-w-0">
            <a href="{{ route('dawn.failed') }}" wire:navigate
        ...
        @else
            <div class="flex items-center gap-2 self-start shrink-0">
                <button
                    wire:click="retry"
                    class="inline-flex items-center gap-2 px-4 py-2 bg-dawn-500 hover:bg-dawn-600 text-white text-sm font-medium rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-dawn-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900"
                >
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <button
                    ...
                    class="inline-flex items-center gap-2 px-4 py-2 bg-red-500 hover:bg-red-600 text-white text-sm font-medium rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900"
                >
    ...
    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm overflow-hidden">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-gray-100 dark:divide-gray-700/50">
            ...
            <div class="px-4 py-4 sm:px-5 sm:py-5">
                ...
                <dd class="mt-2 text-sm font-medium text-gray-900 dark:text-white break-all">{{ $job['class'] ?? $job['name'] ?? '-' }}</dd>
            </div>
            {{-- Queue --}}
            <div class="px-4 py-4 sm:px-5 sm:py-5">
            ...
            {{-- Failed At --}}
            <div class="px-4 py-4 sm:px-5 sm:py-5">
                <dt class="text-xs font-medium uppercase tracking-wider text-gray-400 dark:text-gray-500">Failed At</dt>
                <dd class="mt-2 text-sm font-medium text-gray-900 dark:text-white">{{ $this->formatDate($job['failed_at'] ?? null) }}</dd>
            </div>
        </div>
    </div>
